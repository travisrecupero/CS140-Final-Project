	...
	public Model(HaltCallBack cb) {
		...
		INSTR[0x2] = (arg, mode) -> {
			...
			if(mode != DIRECT) {
				...
				dataMemory.data[cpu.memoryBase+arg] = cpu.accumulator;
				cpu.instructionPointer++;
			}
		};
...
//			}
	...
	public void clearJob() {
		...
		codeMemory.clearCode(currentJob.getStartcodeIndex(), currentJob.getStartcodeIndex() + currentJob.getCodeSize());
		cpu.accumulator = 0;
